                ...
                <div class="p-5">
                  ...
                  <form class="user" @submit.prevent="login()">
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control form-control-user" v-model="name" aria-describedby="emailHelp" placeholder="Enter Your Name..." />
                    </div>
                    <div class="form-group">
                      <label for="">Password</label>
                      <div class="d-flex">
                        <input required :type="passwordField" class="form-control form-control-user" v-model="password" placeholder="Password" />
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      this.isLoading = true;
      axios
        .post(this.$store.state.host + "/api/login", { custom_id: this.name, password: this.password })
        .then((res) => {
