<template>
  <div class="container-fluid mt-5" id="tagprint">
              ...
              <table class="table table-bordered my-2 text-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Rp.{{ data.harga_air }}.00</td>
                    <td>Rp.{{ data.total_harga }}.00</td>
                  </tr>
                  <tr>
...
export default {
  ...
  methods: {
    print() {
      ...
      WinPrint.document.write(`<!DOCTYPE html>
                ...
                <div class="row text-center mt-5">
                    <div class="col-12 ">
                        <p class="fs-1">
                        info WA : 082328023122 / 082140407774<br>
                        * Pembayaran Paling Lambat Tanggal 30 * <br>
                        -Gunakan Air dengan Bijak-<br>
                        Petugas
                        </p>
                    </div>
                </div>
    ...
    getData() {
      axios
        .get(this.$store.state.host + "/api/transaction/" + this.$route.params.id, { headers: { Authorization: `Bearer ${window.localStorage.getItem("token")}` } })
        .then((res) => {
          this.data = res.data;
        })
        .catch((err) => {
