       ...
       <!-- Sidebar -->
        <ul class="navbar-nav bg-white sidebar shadow-sw  accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <router-link class="nav-link" to="/pelanggan/dashboard">
                    <i class="fas fa-home"></i>
                    <span>Dashboard</span></router-link>
            </li>

            <li class="nav-item active">
                <router-link class="nav-link" to="/pelanggan/tagihan">
                    <i class="fas fa-chart-bar"></i>
                    <span>Tagihan</span></router-link>
            </li>

            <li class="nav-item">
                <router-link class="nav-link" to="/pelanggan/transaksi">
                    <i class="fas fa-calculator"></i>
                    <span>Transaksi</span></router-link>
            </li>

            <li class="nav-item">
                <router-link class="nav-link" to="/pelanggan/profile">
