...
export default {
  ...
  methods: {
    ...
    sortrt(data) {
      axios
        .get(`${this.$store.state.host}/api/tagihan-rtIDT/${data}/${this.id}`, { headers: { Authorization: `Bearer ${window.localStorage.getItem("token")}` } })
        .then((res) => {
          $("#my-table")
            .DataTable()
            .destroy();
    ...
    getData() {
      axios
        .get(`${this.$store.state.host}/api/tagihan-pelanggan/${this.id}`, { headers: { Authorization: `Bearer ${window.localStorage.getItem("token")}` } })
        .then((res) => {
          this.data = res.data;
          this.tabla();
        })
    ...
    getDate() {
      axios
        .get(`${this.$store.state.host}/api/tagihan-getDatePL/${this.id}`, { headers: { Authorization: `Bearer ${window.localStorage.getItem("token")}` } })
        .then((res) => {
          this.date = res.data;
        })
        .catch((err) => {
